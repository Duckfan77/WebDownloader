...
titlePath='//h1[@class="entry-title" or @class="page-title"]'
bodyPath='//div[@class="entry"]'
nextPath='//div[@class="entry"]//p//a[contains(text(), "–>") or contains(text(), "Extra")]'
XPath=True
